...
dataset_pg_train = dgl.data.CSVDataset('./csvGraph4IO_big_train/',force_reload=True)
dataset_pg_test = dgl.data.CSVDataset('./csvGraph4IO_big_test/',force_reload=True)
# dataset_ll = torch.load('./graph_list_benchmark_test_all_pg_plus_rodinia.pt')
#
numDimension=2
test_idx = list(range(0,2500))
...
model_pg = HeteroRegressor(numDimension, 64, 1, etypes)
